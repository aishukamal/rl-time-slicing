...
func (g *GCRBackend) SetExecCommand(f func(ctx context.Context, name string, args ...string) ([]byte, error)) {
	g.execCommand = f
}

func (g *GCRBackend) SetLookPath(f func(string) (string, error)) {
	g.lookPath = f
}
