...
POD=$($K --context=$CTX get pods -n default -l app=colocated-m3a2 -o jsonpath="{.items[0].metadata.name}")
OUT=/Users/aishuk/workspaces/GPU-CR/elastic-rl-poc/m3-results/colocated-b64/incremental.log
