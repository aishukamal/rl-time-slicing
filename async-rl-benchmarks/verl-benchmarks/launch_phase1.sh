...
ROLLOUT_STEPS=15360   # ~30 logged steps (512 samples per step-cycle)
...
common_train_args() {
  ...
  cat <<ARGS
        ...
        async_training.staleness_threshold=0.1 async_training.trigger_parameter_sync_step=4 \\
        async_training.partial_rollout=True async_training.require_batches=4
ARGS
}
...
make_head_pod p1-44 p1-44 8 8 "$(common_train_args 1 4 1 4 dapo44_mode4)"
make_head_pod p1-88-head p1-88-head 8 16 "$(common_train_args 1 8 1 8 dapo88_mode4)"
make_worker_pod p1-88-worker "p1-88-head-svc.default.svc.cluster.local"
make_head_pod p1-412-head p1-412-head 8 16 "$(common_train_args 2 6 2 2 dapo412_mode4)"
