...
fig.suptitle(
    "veRL fully-async disagg — long-CoT math RL at 16K response cap (R1-Distill-Qwen-1.5B, 1 trainer + 1 rollout H100)\n"
    "GPU utilization — 5s bins · trainer 59.6% idle in 3.3-4.8 min blocks · rollout 99.5% util",
