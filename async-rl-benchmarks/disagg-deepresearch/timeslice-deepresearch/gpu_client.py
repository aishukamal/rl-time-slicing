...
# Set TIMESLICE_DISABLED=1 to run without the timeslice orchestrator stack
# (baseline disagg benchmark: all acquire/yield/register calls become no-ops).
def _timeslice_disabled() -> bool:
  return os.environ.get("TIMESLICE_DISABLED", "0") in ("1", "true", "True")
